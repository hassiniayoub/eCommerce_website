    ...
    <div class="content">
        ...
        <div class="content-bar">
            ...
            <div class="path-bar">
                ...
                <button onclick="window.open('http://localhost/ecomweb/assets/pg/admins/add_product.php', '_self');">أضف منتوج جديد</button>
            </div>
            ...
            <table class="table table-bordered" role="table">
                <thead>
                    <tr>
                        <th width="2%">#</th>
                        <th class="text-right" width="15%">عنوان النتوج</th>
                        <th class="text-right" width="10%">السعر الأصلي</th>
                        ...
                        <th class="text-right" width="15%">نوع القسم</th>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <td>' . $row["title"] . '</td>
                        <td>' . $row["old_price"] . 'dh</td>
                        <td>' . $row["price"] . 'dh</td>
                        <td> 1</td>
                        <td> <a href="http://localhost/ecom/home/show/4" target="_blanck">0</a></td>
                        <td>' . $row["cat_type"] . '</td>
                        <td data-title="التحكم" class="text-center">
                            <a href="assets/pg/admins/edit_product.php?prd_id=' . $row["id"] . '" class="edit-btn">تعديل</a>
