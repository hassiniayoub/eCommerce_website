        ...
        <div class="content-bar">
            ...
            if (isset($_POST["coupon_sub"])) {
                ...
                if (empty($coupon_name) ||
                    ...
                    if ($conn->query($sql) === TRUE) {
                        echo "<div style='margin: 20px; font-size: 18px; padding: 10px 15px; background-color: #e6fff5;'>لقد تم إضافة كود التخفيض بنجاح</div>";
                    }
                    else {
            ...
            <div class="container-form">
                <form action="" method="post">
                    <input type="text" name="discount_code" id="" placeholder="كود التخفيض">
                    <input type="date" name="discount_end_date" id="" placeholder="تاريخ إنتهاء الخصم">
